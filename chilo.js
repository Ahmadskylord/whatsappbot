...
const isAuthor = '6283856410394'+'@s.whatsapp.net'.includes(m.sender)
...
const ownSc = `6285601059864`
const ownScName = `𝘿𝘼𝙁𝙁𝙕𝙓𝘿 𝙊𝙁𝙁𝘾`
if (command) {
    console.log(
        `${m.isGroup ? '\x1b[0;32mKIZH\x1b[1;32m-host' : '\x1b[1;32mKIZH-host'} \x1b[0m[ \x1b[1;37m${command} \x1b[0m] at \x1b[0;32m${global.calender}\x1b[0m\n› ${m.chat}\n› FROM :\x1b[0;37m${m.sender.split('@')[0]}\x1b[0m${m.pushName ? ', ' + m.pushName : ''}\n› IN :\x1b[0;32m${m.isGroup ? groupName : 'chat private'}\x1b[0m`
    );
...
let menu = `toko pulsa daniel store id
...
title: auttor,
body: 'bodynya',
thumbnailUrl: "https://telegra.ph/file/401f71fd68421a96d2fce.jpg", 
sourceUrl: "https://chat.whatsapp.com/IxxGZuyKOOlICvAQiKDIPv",
mediaType: 1,
...
*𝙔𝙊𝙐𝙏𝙐𝘽𝙀*
https://youtube.com/@daffzofficial
`
reply(soScript)
break // (?); bot script
...
🛒> TOPUP ${namaproduk}
 ...
 >ʟɪsᴛ ʜᴀʀɢᴀ? 
 ᴘᴍ wa.me/6285601059864?text=Bang+Mau+Topup+Game
...
await chilo.sendMessage(m.chat, { text: `*Kalo mau push ketik ke gni*\n.pushkon2 120363144535686704@g.us|halo meks save DAFFZ` }, { quoted: txrk })
}
break
case 'ramlist':{
	let menu = `
...
//▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰//
    case 'panel':{
	let menu = `
CARA BIKIN PANEL BY 𝐃𝐀𝐅𝐅𝐙 𝐎𝐅𝐅𝐂🔥

CARA ADD USER PANEL :
ram user,nomer

contoh : 1gb daffz,628xxxxxx [ isi pake no lu ]
...
reply(`DONE BY 𝘿𝘼𝙁𝙁𝙕𝙓𝘿

 *DONE CRATE USER + SERVER ID :* ${user.id}
JANGAN LUPA DI PAKE YAH ASU
KALO NGGA NANTI DI HAPUS BANG DAFFZ`)
ctf = `Hai @${u.split`@`[0]}
...
JANGAN LUPA DI PAKE YAH BANG KALO G MAU BANG 𝘿𝘼𝙁𝙁𝙕 HAPUS
`)
...
JANGAN LUPA DI PAKE DARI PADA BANG DAFFZ HAPUS
`)
...
JANGAN LUPA DI PAKE YAH ASU NANTI DI HAPUS BANG DAFFZ 
`)
...
JANGAN LUPA DI PAKE BIAR G DI HAPUS SAMA BANG DAFFZ
`)
